...
describe('samples', function() {
  ...
  var sampleTestMatrix = [
    ...
    // Validating in draft-04 mode to make sure Ajv's backwards compatible options are set properly
    ...
    // Validating in draft-07 mode should force Ajv to get loaded
